...
请在回答时保持礼貌和专业。
"""
airport_knowledge_prompt_type = [{"direct":"直接回答用户的问题"},{"clarify":"生成澄清问题，要求用户进一步澄清需求"}]
AIRPORT_KNOWLEDGE_PROMPT = """
请使用下面 <context> XML 标签内提供的信息来{prompt_type}。
<context> 
{context}
</context> 
...
MASTER_SYSTEM_PROMPT = """你是民航机场的智能客服系统决策助手。你的唯一任务是识别用户的意图，并将他们的请求路由到相应的工具。不要对用户进行任何直接回答或解释。
...
"""
master_examples = [{
    "user_query":"请问明天下午3点的重庆飞济南航班是什么时候到？",
    "correct_operation":"使用flight_info_query，参数'明天下午3点从重庆飞往济南的航班什么时候到达？'"
    },
    {
        "user_query":"我可以带充电宝上飞机吗？",
        "correct_operation":"使用airport_knowledge_query，参数'乘客可以携带充电宝登机吗？'"
    },
    {
        "user_query":"我要去北京",
        "correct_operation":"使用flight_info_query，参数'从济南到北京的航班是什么时候？'"
    },
    {
        "user_query":"谢谢你的帮助",
        "correct_operation":"使用airport_knowledge_query，参数'谢谢你的帮助'"
    },
    {
        "user_query":"我想租一个轮椅",
        "correct_operation":"使用business_handler，参数'我想租一个轮椅'"
    }
]
...
translation_examples = [
    {
        "language":"英文",
        "user_input":"你好，我想确认一下航班延误的情况。",
        "correct_output":"Hello, I want to confirm the flight delay situation."
    },
    {
        "language":"法文",
        "user_input":"你好，我想确认一下航班延误的情况。",
        "correct_output":"Bonjour, je veux confirmer la situation de retard du vol."
    },
    {
        "language":"日文",
        "user_input":"你好，我想确认一下航班延误的情况。",
        "correct_output":"フライトの遅延について確認したいのですが。"
    },
    {
        "language":"中文",
        "user_input":"你好，我想确认一下航班延误的情况。",
        "correct_output":"你好，我想确认一下航班延误的情况。"
    }
