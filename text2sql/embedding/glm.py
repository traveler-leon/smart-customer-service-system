...
class GlmEmbedding(AsyncEmbeddingProvider):
    ...
    def __init__(self, config=None):
        ...
        self.embedding_model = self.config.get("embedding_model", "Embedding-3")
        self.dimensions = self.config.get("dimensions", 2048)
